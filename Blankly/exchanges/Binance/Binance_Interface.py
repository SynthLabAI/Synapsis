...
class BinanceInterface(CurrencyInterface):
    ...
    def get_open_orders(self, product_id=None):
        ...
        if product_id is not None:
            ...
            orders['product_id'] = utils.to_synapsis_coin_id(orders['product_id'], 'binance', quote_currency=None)
            return orders
        else:
        ...
        for i in range(len(orders)):
            ...
            orders[i]['product_id'] = utils.to_synapsis_coin_id(orders[i]['product_id'], 'binance', quote_currency=None)
