...
from Synapsis.exchanges.Coinbase_Pro.Coinbase_Pro_Websocket import Tickers as Coinbase_Pro_Websocket
from Synapsis.exchanges.Binance.Binance_Websocket import Tickers as Binance_Websocket
