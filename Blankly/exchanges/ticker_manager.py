...
from Synapsis.exchanges.Coinbase_Pro.Coinbase_Pro_Websocket import Tickers as Coinbase_Pro_Ticker
from Synapsis.exchanges.Binance.Binance_Websocket import Tickers as Binance_Ticker
...
class TickerManager(WebsocketManager):
    def __init__(self, default_exchange, default_currency):
        ...
        if default_exchange == "binance":
            default_currency = Synapsis.utils.to_exchange_coin_id(default_currency, "binance").lower()
    ...
    def create_ticker(self, callback, log=None, currency_id=None, override_exchange=None):
        ...
        """
        preferences = Synapsis.utils.load_user_preferences()
        ...
        if exchange_name == "coinbase_pro":
            ...
            currency_id = Synapsis.utils.to_exchange_coin_id(currency_id, "binance").lower()
            if sandbox_mode:
