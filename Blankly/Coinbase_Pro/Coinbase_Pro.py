...
class Coinbase_Pro(Exchange):
    def __init__(self, portfolio_name=None, auth_path="Keys.json"):
        ...
        auth, defined_name = Synapsis.auth_constructor.load_auth_coinbase_pro(auth_path, portfolio_name)
    ...
    def append_model(self, model, coin, args=None):
        ...
        Args:
            model: Model object to be used. This is objects inheriting synapsis_bot
