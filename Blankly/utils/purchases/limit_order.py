...
"""
from Synapsis.utils.purchases.order import Order
from Synapsis.utils.utils import pretty_print_JSON
...
class LimitOrder(Order):
    ...
    #     fee = (self.__valueAtTime * self.__amountCurrency) * Synapsis.Constants.PRETEND_FEE_RATE
    #     if show:
    #         print(fee)
    #     return fee
    #
