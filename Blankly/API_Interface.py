...
class APIInterface:
    ...
    def market_order(self, product_id, side, funds, **kwargs):
        ...
        if self.__exchange_name == "coinbase_pro":
            ...
            modified_product_id = Synapsis.utils.to_exchange_coin_id(product_id, "binance")
    ...
    def get_open_orders(self, product_id=None, **kwargs):
        ...
        if self.__exchange_name == "coinbase_pro":
            ...
            if product_id is not None:
                product_id = Synapsis.utils.to_exchange_coin_id(product_id, "binance")
    ...
    def get_market_limits(self, product_id):
        ...
        if self.__exchange_name == "coinbase_pro":
            ...
            converted_symbol = Synapsis.utils.to_exchange_coin_id(product_id, 'binance')
            current_price = None
