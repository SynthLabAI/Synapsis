...
If you don't want to use our `init` command, you can find the same files in the `examples` folder under [`settings.json`](https://github.com/Synapsis-Finance/Synapsis/blob/main/examples/settings.json) and [`keys.json`](https://github.com/Synapsis-Finance/Synapsis/blob/main/examples/keys_example.json)
