...
stocks = synapsis.Alpaca()
crypto = synapsis.CoinbasePro()
...
![Image](https://firebasestorage.googleapis.com/v0/b/synapsis-6ada5.appspot.com/o/backtest_result.png?alt=media&token=4ef8ff1d-034c-474b-a662-f46393fe5597)
