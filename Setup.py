...
setup(
  ...
  packages = ['Synapsis'],   # Chose the same as "name"
  ...
  url = 'https://github.com/EmersonDove/Synapsis',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/EmersonDove/Synapsis/archive/v0.1.0-alpha.tar.gz',    # I explain this later on
