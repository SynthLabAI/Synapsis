...
class CryptoWebsockets:
    ...
    def __init__(self):
        ...
        self.price_manager = synapsis.TickerManager('coinbase_pro', 'BTC-USD')
        self.orderbook_manager = synapsis.OrderbookManager('coinbase_pro', 'BTC-USD')
    ...
    def timeout(self, start_at: int):
        ...
        print(synapsis.utils.pretty_print_json(self.validated_responses))
        assert False
