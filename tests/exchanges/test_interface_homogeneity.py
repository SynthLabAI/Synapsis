...
from synapsis.utils.time_builder import build_day
from synapsis.utils.utils import compare_dictionaries, get_base_asset, get_quote_asset
...
class InterfaceHomogeneity(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.Kucoin = synapsis.Kucoin(portfolio_name="KC Sandbox Portfolio",
                                    keys_path='./tests/config/keys.json',
                                    settings_path="./tests/config/settings.json")
        ...
        cls.Kucoin_data = synapsis.Kucoin(portfolio_name="KC Data Keys",
                                         keys_path='./tests/config/keys.json',
                                         settings_path="./tests/config/settings.json")
        ...
        cls.Binance_data = synapsis.Binance(portfolio_name="Data Key",
                                           keys_path='./tests/config/keys.json',
                                           settings_path="./tests/config/settings.json")
        ...
        cls.Oanda = synapsis.Oanda(portfolio_name="oanda test portfolio",
                                  keys_path='./tests/config/keys.json',
                                  settings_path="./tests/config/settings.json")
        ...
        cls.FTX = synapsis.FTX(portfolio_name="Main Account",
                              keys_path='./tests/config/keys.json',
                              settings_path="./tests/config/settings.json")
        ...
        cls.paper_trade_binance_data = synapsis.PaperTrade(cls.Binance_data)
    ...
    def test_market_order(self):
        ...
        # These are the objects generated by synapsis
        order_responses = []
    ...
    def check_account_delta_market(self, before: dict, after: dict, order: MarketOrder) -> None:
        ...
        self.assertAlmostEqual(synapsis.trunc(before['available'], 2) + order.get_size(),
                                synapsis.trunc(after['available'], 2), delta=1)
