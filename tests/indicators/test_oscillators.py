...
import unittest
from Synapsis.indicators import rsi, stochastic_oscillator, percentage_price_oscillator, absolute_price_oscillator, chande_momentum_oscillator, aroon_oscillator
