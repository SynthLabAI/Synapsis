...
from synapsis.enums import Side, OrderType, ContractType, OrderStatus, HedgeMode, MarginType, PositionMode, TimeInForce
...
def valid_product_helper(futures_interface: FuturesExchangeInterface, product):
    ...
    print(f'{exc=} {futures_interface.to_synapsis_symbol(exc)=} {symbol=}')
    assert futures_interface.to_synapsis_symbol(exc) == symbol
