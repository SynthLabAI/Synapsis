...
if __name__ == "__main__":
    ...
    paper_trade = Synapsis.PaperTrade(coinbase_pro.get_interface())
    ...
    hist = paper_trade_interface.get_product_history('BTC-USD',
                                                     time.time() - Synapsis.time_builder.build_day() * 20,  # 20 days before now
                                                     time.time(),  # To now
                                                     Synapsis.time_builder.build_hour())  # At one hour resolution
