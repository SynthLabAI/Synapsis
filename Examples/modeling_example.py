...
if __name__ == "__main__":
    ...
    p.line(x, Synapsis.analysis.moving_average_set(history["close"], 100), line_width=2, line_color='pink',
           legend_label="100d MA")
    # Plot 50 day moving average
    p.line(x, Synapsis.analysis.moving_average_set(history["close"], 50), line_width=2, line_color='yellow',
           legend_label="50d MA")
