...
deployment_settings = __SynapsisSettings('./synapsis.json', default_deploy_settings,
                                        "Make sure a synapsis.json file is placed in the same folder as the project "
