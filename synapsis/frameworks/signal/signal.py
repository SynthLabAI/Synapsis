...
from synapsis.frameworks.signal.signal_runner import SignalRunner
...
class Signal:
    def __init__(self, exchange: Exchange,
        ...
        Function Signatures:
        init(signal_state: synapsis.SignalState)
        evaluator(symbol: str, signal_state: synapsis.SignalState)
        teardown(signalState: synapsis.SignalState)
        formatter(raw_results: dict, signal_state: synapsis.SignalState)
        ...
        if not synapsis.is_deployed and synapsis._signal_runner is None:
            synapsis._signal_runner = SignalRunner(self.resolution)
        ...
        if synapsis.is_deployed:
            synapsis.reporter.export_signal(self)
    ...
    def __run(self):
        ...
        synapsis.reporter.export_signal_result(self)
