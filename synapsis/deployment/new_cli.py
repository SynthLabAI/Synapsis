...
def init_starter_model(model):
    ...
    clean_synapsis_json()
    print_success('Done!')
    print_success('To add exchange keys to your model, do `synapsis key`')
    print_success('To deploy this model, do `synapsis deploy`.')
...
def generate_synapsis_json(api: Optional[API], model: Optional[dict], model_type, main_script):
