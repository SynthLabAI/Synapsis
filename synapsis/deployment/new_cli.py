...
from synapsis.deployment.keys import add_key, split_exchange
...
def exchange_key_fields():
    return json.loads(pkgutil.get_data('synapsis', 'data/exchange_key_fields.json').decode('utf-8'))
...
def synapsis_init(args):
    ...
    # TODO generate synapsis.json if model was created
