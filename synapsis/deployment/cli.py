...
init_parser.add_argument('exchange', nargs='?', default='none', type=str, help='One of Synapsis\'s Supported Exchanges')
...
def main():
    ...
    if which == 'deploy':
        ...
        if len(projects) == 0:
            print(TermColors.FAIL + "Please create a project with 'synapsis create' first." + TermColors.ENDC)
            return
        ...
        if user_defined_exchange == 'binance' or user_defined_exchange == 'binance-us': 
            ...
            settings = requests.get('https://raw.githubusercontent.com/Synapsis-Finance/Synapsis/main/examples/settings.json')
        elif user_defined_exchange == 'binance-com':
            print("Downloading settings defaults for Binance COM...")
            settings = requests.get('https://raw.githubusercontent.com/Synapsis-Finance/Synapsis/main/examples/settings-com.json')
        else:
        ...
        if user_defined_exchange == 'alpaca' or user_defined_exchange == 'cbpro' or user_defined_exchange == 'oanda':
            ...
            backtest = requests.get('https://raw.githubusercontent.com/Synapsis-Finance/Synapsis/main/examples/backtest.json')
        else:
            print("Downloading backtest defaults for USDT account values...")
            backtest = requests.get('https://raw.githubusercontent.com/Synapsis-Finance/Synapsis/main/examples/backtest-usdt.json')
        ...
        if user_defined_exchange == 'binance-com' or user_defined_exchange == 'binance-us':
            bot = requests.get('https://raw.githubusercontent.com/Synapsis-Finance/Synapsis/main/examples/rsi-examples/rsi-binance.py')
        else:
            bot = requests.get(f'https://raw.githubusercontent.com/Synapsis-Finance/Synapsis/main/examples/rsi-examples/rsi-{user_defined_exchange}.py')
        ...
        if args['path'] is None:
            ...
            deployment_location = os.path.join(synapsis_folder, deployment_script_name)
            try:
