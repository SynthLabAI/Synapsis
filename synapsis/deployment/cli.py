...
init_parser = subparsers.add_parser(
    'init', help='Sub command to create a synapsis-enabled development environment.')
init_parser.set_defaults(which='init')
init_parser.add_argument('exchange', nargs='?', default='none',
                         type=str, help='One of Synapsis\'s Supported Exchanges')

login_parser = subparsers.add_parser(
    'login', help='Log in to your synapsis account.')
...
run_parser = subparsers.add_parser(
    'run', help='Mimic the run mechanism used in synapsis deployment.')
    ...
    if which == 'deploy':
        ...
        if user_defined_exchange == 'alpaca' or user_defined_exchange == 'coinbase_pro' or user_defined_exchange == 'oanda':
            ...
            backtest = requests.get(
                'https://raw.githubusercontent.com/Synapsis-Finance/Synapsis/main/examples/backtest.json')
        ...
        if user_defined_exchange == 'binance.com' or user_defined_exchange == 'binance.us':
            bot = requests.get(
                'https://raw.githubusercontent.com/Synapsis-Finance/Synapsis/main/examples/rsi-examples/rsi-binance.py')
        else:
            bot = requests.get(
                f'https://raw.githubusercontent.com/Synapsis-Finance/Synapsis/main/examples/rsi-examples/rsi-{user_defined_exchange}.py')
        ...
        if args['path'] is None:
            ...
            os.chdir(os.path.join(synapsis_folder,
