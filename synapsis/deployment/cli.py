...
def main():
    ...
    if which == 'deploy':
        if args['path'] is None:
            ...
            synapsis_dist_folder = os.path.join(args['path'], './synapsis_dist')
            try:
                os.mkdir(synapsis_dist_folder)
                print("Creating distribution folder...")
            except FileExistsError:
                pass

            model_path = os.path.join(synapsis_dist_folder, 'model.zip')
