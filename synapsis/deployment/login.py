"""
    Functions for synapsis login/logout commands
...
from synapsis.deployment.ui import print_work, print_failure, print_success, show_spinner

SUCCESS_URL = 'https://firebasestorage.googleapis.com/v0/b/synapsis-6ada5.appspot.com/o/login_success.html?alt=media&token=41d734e2-0a88-44c4-b1dd-7e081fd019e7'
FAILURE_URL = 'https://firebasestorage.googleapis.com/v0/b/synapsis-6ada5.appspot.com/o/login_failure.html?alt=media&token=b2d9f6dc-aa54-4da2-aa6f-1f75a4025634'
...
def get_token_file() -> pathlib.Path:
    return get_datadir() / 'synapsis' / 'auth.json'
