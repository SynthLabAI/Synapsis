...
from synapsis.deployment.ui import print_failure, show_spinner
...
from synapsis.deployment.ui import confirm
...
def check_key(exchange, tld, data):
    ...
    if not test_func:
        print_failure(f'Synapsis can\'t check {exchange} API Keys at this time')
        return True
