...
synapsis_deployment_url = 'http://localhost'  # 'https://deploy.synapsis.finance'
...
class API:
    def __init__(self, token, override_url: str = None):
        if override_url:
            ...
            self.url = synapsis_deployment_url
        ...
        try:
            ...
            raise KeyError("Failed to authenticate - run \"synapsis login\" again.")
    ...
    def __request(self, type_: str, route: str, json_: dict = None, params: dict = None, file=None, data: dict = None):
        """
        Create a general request to the synapsis API services
