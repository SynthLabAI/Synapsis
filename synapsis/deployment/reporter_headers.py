...
class Reporter:
    ...
    def export_backtest_result(self, platform_result: dict):
        ...
        Args:
            platform_result: A synapsis backtest result object
        """
        pass
    ...
    def chat(self, message: str):
        ...
        Create the webhook following these instructions:
            ...
            5. In the Name field, enter a name for your webhook (such as "Synapsis Notifications").
            6. In the Avatar URL field, enter a URL to an icon (such as https://synapsis.finance/_nuxt/img/synapsis-black.c8ffff6.svg).
            7. Click Save.
