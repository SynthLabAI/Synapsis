...
class StrategyLogger(ABCExchangeInterface):
    ...
    def get_account(self, symbol: str = None) -> AttributeDict:
        ...
        synapsis.reporter.log_strategy_event(self.strategy, 'get_account', out, args=symbol)
        return out
    ...
    def market_order(self, symbol: str, side: str, size: float) -> MarketOrder:
        ...
        synapsis.reporter.log_strategy_event(self.strategy, 'market_order', out, args=args)
        return out
    ...
    def limit_order(self, symbol: str, side: str, price: float, size: float) -> LimitOrder:
        ...
        synapsis.reporter.log_strategy_event(self.strategy, 'limit_order', out, args=args)
        return out
