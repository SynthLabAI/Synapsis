...
class StrategyLogger(ABCExchangeInterface):
    ...
    def get_account(self, symbol: str = None) -> AttributeDict:
        ...
        synapsis.reporter.log_strategy_event(self.strategy, 'get_account', out, args=args)
        return out
    ...
    def market_order(self, symbol: str, side: str, size: float) -> MarketOrder:
        ...
        synapsis.reporter.log_strategy_event(self.strategy, 'market_order', out.get_response(), args=args)
        return out
    ...
    def limit_order(self, symbol: str, side: str, price: float, size: float) -> LimitOrder:
        ...
        synapsis.reporter.log_strategy_event(self.strategy, 'limit_order', out.get_response(), args=args)
        return out
    ...
    def cancel_order(self, symbol: str, order_id: str) -> dict:
        ...
        synapsis.reporter.log_strategy_event(self.strategy, 'cancel_order', out, args=args)
        return out
    ...
    def get_open_orders(self, symbol: str = None) -> list:
        ...
        synapsis.reporter.log_strategy_event(self.strategy, 'get_open_orders', out, args=args)
        return out
    ...
    def get_order(self, symbol: str, order_id: str) -> dict:
        ...
        # Record the arguments
        synapsis.reporter.log_strategy_event(self.strategy, 'get_order', out, args=args)
        return out
    ...
    def get_fees(self) -> dict:
        ...
        synapsis.reporter.log_strategy_event(self.strategy, 'get_fees', out, args=args)
        return out
    ...
    def get_order_filter(self, symbol: str):
        ...
        synapsis.reporter.log_strategy_event(self.strategy, 'get_order_filter', out, args=args)
        return out
    ...
    def get_price(self, symbol: str) -> float:
        ...
        synapsis.reporter.log_strategy_event(self.strategy, 'get_price', out, args=args)
        return out
