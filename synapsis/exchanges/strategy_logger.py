...
class StrategyLogger(ABCExchangeInterface):
    ...
    def get_account(self, symbol: str = None) -> AttributeDict:
        ...
        synapsis.reporter.log_strategy_event(self.strategy, 'get_account', out, symbol=symbol, account=out)
        return out
    ...
    def market_order(self, symbol: str, side: str, funds: float) -> MarketOrder:
        ...
        synapsis.reporter.log_strategy_event(self.strategy, 'market_order', out,
    ...
    def limit_order(self, symbol: str, side: str, price: float, size: float) -> LimitOrder:
        ...
        synapsis.reporter.log_strategy_event(self.strategy, 'limit_order', out,
                                            symbol=symbol, side=side,
    ...
    def cancel_order(self, symbol: str, order_id: str) -> dict:
        ...
        synapsis.reporter.log_strategy_event(self.strategy, 'cancel_order', out,
