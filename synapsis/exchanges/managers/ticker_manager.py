...
from synapsis.exchanges.interfaces.kucoin.kucoin_websocket import Tickers as Kucoin_Ticker
from synapsis.exchanges.interfaces.ftx.ftx_websocket import Tickers as FTX_Ticker
from synapsis.exchanges.interfaces.okx.okx_websocket import Tickers as Okx_Ticker
...
class TickerManager(WebsocketManager):
    def __init__(self, default_exchange: str, default_symbol: str):
        ...
        if default_exchange == "binance":
            default_symbol = synapsis.utils.to_exchange_symbol(default_symbol, "binance").lower()
        elif default_exchange == "alpaca":
            default_symbol = synapsis.utils.to_exchange_symbol(default_symbol, "alpaca")
        elif default_exchange == "kucoin":
            default_symbol = synapsis.utils.to_exchange_symbol(default_symbol, "kucoin")
        elif default_exchange == "ftx":
            default_symbol = synapsis.utils.to_exchange_symbol(default_symbol, "ftx")
    ...
    def create_ticker(self, callback, log: str = None, override_symbol: str = None, override_exchange: str = None,
        ...
        if exchange_name == "coinbase_pro":
            ...
            override_symbol = synapsis.utils.to_exchange_symbol(override_symbol, "binance").lower()
            if sandbox_mode:
            ...
            override_symbol = synapsis.utils.to_exchange_symbol(override_symbol, "kucoin")
            if sandbox_mode:
            ...
            override_symbol = synapsis.utils.to_exchange_symbol(override_symbol, "alpaca")
            if sandbox_mode:
            ...
            override_symbol = synapsis.utils.to_exchange_symbol(override_symbol, "ftx")
