...
class TickerManager(WebsocketManager):
    def __init__(self, default_exchange: str, default_symbol: str):
        ...
        if default_exchange == "binance":
            default_symbol = synapsis.utils.to_exchange_coin_id(default_symbol, "binance").lower()
        elif default_exchange == "alpaca":
            default_symbol = synapsis.utils.to_exchange_coin_id(default_symbol, "alpaca")
    ...
    def create_ticker(self, callback, log: str = None, override_symbol: str = None, override_exchange: str = None):
        ...
        if exchange_name == "coinbase_pro":
            ...
            override_symbol = synapsis.utils.to_exchange_coin_id(override_symbol, "binance").lower()
            if sandbox_mode:
            ...
            override_symbol = synapsis.utils.to_exchange_coin_id(override_symbol, "alpaca")
            if sandbox_mode:
