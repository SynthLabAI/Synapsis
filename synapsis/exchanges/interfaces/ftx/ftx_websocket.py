...
import traceback
import synapsis
from synapsis.utils.utils import epoch_from_iso8601, to_synapsis_symbol
import synapsis.exchanges.interfaces.ftx.ftx_websocket_utils as websocket_utils
    ...
    def on_message(self, ws, message):
        ...
        if self.stream == "orderbook":
            ...
            for received in received_dict['data']:
                ...
                interface_response['symbol'] = to_synapsis_symbol(received_dict['market'], 'ftx')
                self.ticker_feed.append(interface_response)

                # ISO8601 is converted to epoch in process_trades
                # self.most_recent_time = synapsis.utils.convert_epochs(received['data'][0]['time'])
