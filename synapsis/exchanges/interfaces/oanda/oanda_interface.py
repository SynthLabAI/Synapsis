...
from synapsis.utils import time_interval_to_seconds, utils as utils
import warnings
import pandas as pd
...
class OandaInterface(ExchangeInterface):
    ...
    def get_account(self, symbol=None) -> utils.AttributeDict:
        ...
        # Convert the symbols back into the synapsis symbol
        keys = positions_dict.keys()
        for i in keys:
            i[self.__convert_symbol_to_synapsis(i)] = positions_dict.pop(i)
