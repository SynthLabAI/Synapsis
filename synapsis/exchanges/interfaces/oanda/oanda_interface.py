...
class OandaInterface(ExchangeInterface):
    ...
    def get_products(self) -> list:
        ...
        for instrument in instruments:
            instrument['symbol'] = self.__convert_symbol_to_synapsis(instrument.pop('name'))
    ...
    def get_account(self, symbol=None) -> utils.AttributeDict:
        if symbol is not None:
            symbol = self.__convert_synapsis_to_oanda(symbol)
    ...
    def get_order(self, symbol, order_id) -> dict:
        ...
        homogenized['symbol'] = self.__convert_symbol_to_synapsis(homogenized['symbol'])
    ...
    def get_order_filter(self, symbol: str):
        ...
        resp['symbol'] = self.__convert_symbol_to_synapsis(resp.pop('name'))
    ...
    @staticmethod
    def __convert_symbol_to_synapsis(symbol: str) -> str:
        return symbol.replace('_', '-')

    @staticmethod
    def __convert_synapsis_to_oanda(symbol: str) -> str:
        return symbol.replace('-', '_')
