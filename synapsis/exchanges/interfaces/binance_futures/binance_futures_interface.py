...
from synapsis.enums import MarginType, PositionMode, Side, TimeInForce, HedgeMode
from synapsis.exchanges.interfaces.futures_exchange_interface import FuturesExchangeInterface
from synapsis.exchanges.orders.futures.futures_limit_order import FuturesLimitOrder
from synapsis.exchanges.orders.futures.futures_market_order import FuturesMarketOrder
...
class BinanceFuturesInterface(FuturesExchangeInterface):
    ...
    def get_positions(self,
        ...
        for position in account['positions']:
            ...
            symbol = utils.to_synapsis_symbol(fixed_symbol, 'binance')
